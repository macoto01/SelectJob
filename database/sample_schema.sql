...
(1, 'アプリケーションエンジニア', '正社員', 450, 750,'東京都渋谷区（リモート可）',
...
(user_id, last_name, first_name, last_name_kana, first_name_kana, gender, birthdate, phone, address_pref, salary)
VALUES(2, '山田', '太郎', 'ヤマダ', 'タロウ', '男性', '1994-02-22', '08012754547', '埼玉県', 420);

INSERT INTO resume_desired (user_id, desired_job, desired_location, desired_salary_min, desired_start)
VALUES (2, 'バックエンドエンジニア,フルスタックエンジニア', '東京都,神奈川県', 600, '3ヶ月以内');

INSERT INTO resume_skill (user_id, it_skills, other_skills)
VALUES (2, 'PHP (Laravel), JavaScript (Vue.js / React), Python, Go, SQL (MySQL / PostgreSQL)', 'Git / GitHub, Docker, AWS (EC2 / RDS / S3), Figma, JIRA');

INSERT INTO resume_career
(user_id, company_name, start_year, start_month, end_year, end_month, is_current, position, description, sort_order)
VALUES(2, '株式会社テックスタート', 2022, 4, NULL, NULL, 1, 'バックエンドエンジニア','Go / Python を用いた API サーバー設計・実装。チームリーダーとして4名をマネジメント。', 1),
(2, '株式会社エフエム', 2019, 4, 2022, 3, 0, 'Webエンジニア','Laravel / Vue.js による自社 SaaS プロダクトの機能開発・改善。', 2);

INSERT INTO resume_education (user_id, school_name, faculty, degree, start_year, start_month, end_year, end_month)
VALUES(2, '〇〇大学', '情報工学部 情報工学科', '学士', 2012, 4, 2016, 3),
(2, '〇〇高等学校', '', '', 2009, 4, 2012, 3);

INSERT INTO resume_qualification (user_id, name, acquired_year, acquired_month)
VALUES(2, '応用情報技術者試験', 2021, 6),
(2, 'AWS認定ソリューションアーキテクト アソシエイト', 2020, 3);

INSERT INTO resume_language (user_id, language, level, test_name, test_score)
VALUES (2, '英語', 'ビジネス会話レベル', 'TOEIC', '780点');
